  ...
  return (
    <section className="lg:w-[70%] w-[90%] mx-auto text-white">
      <div className="flex flex-col items-center text-center lg:flex-row lg:items-end lg:text-left gap-6 lg:gap-8">
        <img
          className="size-40 sm:size-48 lg:size-64 pointer-events-none rounded-lg ring-1 shrink-0 object-cover"
          style={{
        ...
        <div className="flex flex-col items-center lg:items-start gap-1 mt-2 lg:mt-0 w-full">
          {/* Bio */}
          <p
            className="montserrat-400 uppercase tracking-[0.2em] text-[10px] mb-1"
          ...
          {/* Meta tags */}
          <div className="grid grid-cols-3 gap-y-5 gap-x-6 montserrat-200 w-full max-w-sm rounded-2xl p-4 lg:p-0">
            {[
              ...
              <div key={label} className="text-center lg:text-left">
                <p
                  className="montserrat-400 uppercase tracking-widest text-[10px] mb-1"
                  style={{ color: "rgba(255,255,255,0.3)" }}
                >
                  {label}
                </p>
