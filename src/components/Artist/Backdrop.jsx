        ...
        <>
          ...
          <div
            style={{
              ...
              pointerEvents: "none",
              background:
                "linear-gradient(to top, var(--page-bg, #0e0d0d) 0%, var(--page-bg, #0e0d0d) 5%, rgba(14,13,13,0.88) 22%, rgba(14,13,13,0.55) 42%, rgba(14,13,13,0.18) 65%, transparent 100%)",
            }}
          />

          <div className={`absolute right-5 bottom-20`}>
            <SubmitReport type="artist" artistId={artistId} />
          </div>
        </>
      )}
